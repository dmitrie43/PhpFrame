...
<head>
    ...
    <style type="text/css">
        ...
        .image { display: flex; justify-content: center; z-index: 1;}
        .gif { display: flex; justify-content: center; z-index: 2; }
    </style>
</head>
<body>
<div class="image">
    <img class="img" src="/public/errors/images/erreur-404-2.jpg" alt="404">
</div>
<div class="gif">
    <img src="/public/errors/images/404.gif" alt="">
</div>
<div class="content">
